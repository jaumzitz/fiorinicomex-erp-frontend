...
export const empresas: Empresa[] = [
  {
    ...
    contatos: [
      { id: 'ct-1', nome: 'Renata Alves', telefone: '(11) 98822-1140', email: 'renata@belavista.com.br', ativo: true },
    ],
    ativo: true,
  },
  {
    ...
    contatos: [
      { id: 'ct-2', nome: 'Paulo Andrade', telefone: '(19) 99711-2233', email: 'paulo@andrademetal.com.br', ativo: true },
      { id: 'ct-3', nome: 'Juliana Reis', email: 'juliana@andrademetal.com.br', ativo: true },
    ],
    ativo: true,
  },
  {
  ...
  },
  {
    ...
    contatos: [
      { id: 'ct-4', nome: 'Marcelo Souza', telefone: '(47) 99123-4455', email: 'marcelo@textilformosa.com.br', ativo: true },
    ],
    ativo: true,
  },
  {
  ...
  },
  {
    ...
    contatos: [{ id: 'ct-5', nome: 'Rafael Torres', email: 'cotacao@bdn.com.br', ativo: true }],
    ativo: true,
  },
  {
    id: 'emp-7',
    ...
    contatos: [{ id: 'ct-6', nome: 'Marina Suzuki', email: 'comercial@proallog.com.br', ativo: true }],
    ativo: true,
  },
  {
    id: 'emp-8',
    ...
    contatos: [{ id: 'ct-7', nome: 'Carlos Nery', email: 'operacional@transit.com.br', ativo: true }],
    ativo: true,
  },
  {
    id: 'emp-9',
    ...
    contatos: [{ id: 'ct-8', nome: 'Bianca Rocha', email: 'freight@agl.com.br', ativo: true }],
    ativo: true,
  },
  {
    id: 'emp-10',
  ...
  {
    id: 'emp-11',
    nomeFantasia: 'Shanghai Steel Parts',
    razaoSocial: 'Shanghai Steel Parts Ltd.',
    tiposRelacionamento: ['exportador'],
    estrangeira: true,
    taxId: '91310000MA1K3RXXX2',
    pais: 'China',
    email: 'sales@shanghaisteelparts.cn',
    contatos: [],
    ativo: true,
  },
  {
    id: 'emp-12',
    nomeFantasia: 'Sunrise Pharma Exports',
    razaoSocial: 'Sunrise Pharma Exports Ltd.',
    tiposRelacionamento: ['exportador'],
    estrangeira: true,
    taxId: 'AAECS1234F',
    pais: 'Índia',
    email: 'exports@sunrisepharma.in',
    contatos: [],
    ativo: true,
  },
  {
    id: 'emp-13',
    nomeFantasia: 'Guangdong Weave Textiles',
    razaoSocial: 'Guangdong Weave Textiles Co.',
    tiposRelacionamento: ['exportador'],
    estrangeira: true,
    taxId: '91440000MA5F8XXX3',
    pais: 'China',
...
export const processos: ProcessoImportacao[] = [
  {
    ...
    comentarios: [
      { id: 'c-1', autor: 'Fiorini', texto: 'Cotação enviada ao cliente, aguardando escolha do fornecedor.', criadoEm: '2026-07-12', visivelNoPortal: true, ativo: true },
    ],
    anexos: [],
  },
  {
  ...
  },
  {
    ...
    atualizadoEm: '2026-07-14',
    comentarios: [
      { id: 'c-2', autor: 'Fiorini', texto: 'MAPA liberou a carga, DI em digitação.', criadoEm: '2026-07-11', visivelNoPortal: true, estagio: 'em_transito', ativo: true },
      { id: 'c-3', autor: 'Fiorini', texto: 'Numerário enviado por e-mail.', criadoEm: '2026-07-14', visivelNoPortal: true, estagio: 'em_transito', ativo: true },
    ],
  ...
  },
  {
    ...
    comentarios: [
      { id: 'c-4', autor: 'Fiorini', texto: 'Aguardando liberação do MAPA há 6 dias.', criadoEm: '2026-07-10', visivelNoPortal: false, estagio: 'em_transito', ativo: true },
    ],
    anexos: [],
  },
  {
    ...
    comentarios: [
      { id: 'c-5', autor: 'Fiorini', texto: 'Pagamento do numerário confirmado. DUIMP registrada.', criadoEm: '2026-07-09', visivelNoPortal: true, estagio: 'desembaraco', ativo: true },
    ],
  ...
  },
  {
    ...
    comentarios: [
      { id: 'c-6', autor: 'Fiorini', texto: 'NF emitida, despesas enviadas ao cliente.', criadoEm: '2026-07-01', visivelNoPortal: true, estagio: 'encerramento', ativo: true },
    ],
